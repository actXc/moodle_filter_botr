...
* API-Secret and API-Key (provided to every user of jwplayer.com (at https://dashboard.jwplayer.com/#/account/apicredentials)
 
* Timeout (how long the link will remain)

* DNS-Mask (your content can have one. If you need one, DNS mask contentserver to serve feeds,
...
* default player (create a player in https://dashboard.jwplayer.com/#/players/list and add the code here to play 
